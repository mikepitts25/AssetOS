...
-- GoTrue scans these token columns on every login; NULLs raise
-- "Database error querying schema" (500). Insert leaves them NULL,
-- so normalize to empty strings for the seeded demo users.
